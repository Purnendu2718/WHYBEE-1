    ...
    <div className="bg-slate-800 border border-slate-700 rounded-2xl p-8 max-w-md w-full shadow-2xl">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-xs text-slate-400">Access your grades, attendance & fees</p>
        </div>
      </div>
      ...
      <form onSubmit={handleLogin} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-2.5 bg-blue-600 hover:bg-blue-500 text-white font-semibold text-sm rounded-lg transition disabled:opacity-50 shadow-md"
        >
      ...
      <div className="mt-6 pt-6 border-t border-slate-700/80 text-center">
        ...
        <button
          ...
          className="text-xs text-blue-400 hover:text-blue-300 bg-slate-900/80 px-3 py-1.5 rounded border border-slate-700 transition"
        >
          Fill Seed Credentials (student1@college.edu)
        </button>
      </div>
    </div>
  );
